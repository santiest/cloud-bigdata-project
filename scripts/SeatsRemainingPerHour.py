...
result_df3 = result_df2.withColumn('Hour', split(result_df2.auxhour, ':').getItem(0))\
                       .drop('auxhour','segmentsDepartureTimeRaw', 'segmentsAirlineName')
...
result_df3.sort('Airline', 'Hour').write.option("header",True).csv("SeatsRemainingPerHour")
